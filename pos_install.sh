...
if [ "$EUID" -eq 0 ]; then
  ...
  echo "   Si usas sudo, el entorno virtual (venv) de Python quedará bajo propiedad de root,"
  echo "   impidiendo que tu usuario pueda utilizar 'pip' u operar sin alterar el sistema base."
  echo "   Las dependencias seguras del sistema te pedirán sudo con tu contraseña individualmente."
  echo "   Uso correcto: ./pos_install.sh"
  exit 1
fi
